...
export default defineComponent({
  ...
  setup() {
    const imgDesktop = 'src/assets/posts/adrasan-suluada/adrasan-suluada.jpg';
    const imgMobile =
      'src/assets/posts/adrasan-suluada/adrasan-suluada-slider-1.jpg';
