...
export default {
  ...
  imgMobile: imgMobile,
  breadCrumbsCategory: 'Adrasan',
  breadCrumbsCategoryRoute: '/antalya', // /antalya/adrasan kategorisine gidecek
  breadCrumbsTourLabel: 'Adrasan Suluada Boat Tour',
  articleTitle: 'Adrasan Suluada Boat Tour',
  articleSummaryText:
  ...
  sliderImages: [slider1, slider2, slider3],
  articleFullText:
